...
// prompt pre setup
  const secondPrompt = 
    ...
    answer: Crew3 is a plateform that allows communities to undertake quests for a specific project (learning, sharing, promoting a project).
    The goal is to have people discovering the project with a bit of fun, while getting rewarded for it.
    You can join here : https://carbonable.crew3.xyz/
    
    question: What rewards does Carbonable offer to Crew3 participants?
    answer: Crew3 participants can gained a Community Badge (Green Pioneer) that will have utility in the future. Depending on their involvment and a fair & random selection process, Crew3 participants might get early access to future mints (allowlist).
    ...
    answer: The roadmap is accessible on https://airtable.com/shrr45aBMh4pFeyHA/tblugTDiuOU3Am7oq
    ...
    answer: You can follow the link here below to access Carbonable Project on the secondary marketplace :
    - Banegas Farm Project : https://mintsquare.io/collection/starknet/0x04047810e4f759336f941a16b6de9d8d2f934e976b9a9431a2964646df9025c6
    - Las Delicias Project : https://mintsquare.io/collection/starknet/0x00ebf4bbab9c934fa0212c9358331d4a9543ad66a7e0007d4a720cfa6b56061e
    
    question: Where can I join the Carbonable Discord?
    answer: You can join the Carbonable Dsscord on https://discord.com/invite/Huspzn4teW
    ...
    question: How to apply for a job at Carbonable ?
    answer: You can submit your application to https://airtable.com/shrn6Bv6VCo1nZofM
    
    question: How to Mint ? Minting Tutorial ?
    answer: You will find all related information on https://medium.com/@carbonable/get-ready-to-participate-in-carbonables-premium-carbon-removal-projects-9b484f558fb6
    
    question: How to get a Starknet Wallet ? How to set up a Starknet Wallet ?  How to fund my Starknet Wallet ? How to add money to mint on Carbonable ? How to bridge funds from CEX, Metamask, Binance ?
    answer: You will find all related information on https://medium.com/@carbonable/get-ready-to-participate-in-carbonables-premium-carbon-removal-projects-9b484f558fb6 
